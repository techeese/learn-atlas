      ...
      "lessons": [
        {
          ...
          "mcq": [
            ...
            {
              "q": "A source can have high Shannon entropy yet still be cryptographically weak. Which quantity captures its true strength as key material?",
              "choices": [
                "Its variance",
                "Its collision entropy, $-\\log\\sum p_i^2$",
                "Its min-entropy $H_\\infty=-\\log\\max_i p_i$ — the adversary's single best guess",
                "Its Hartley entropy $\\log|\\mathrm{supp}(p)|$"
              ],
              "answer": 2,
          ...
          "homework": [
            {
              "prompt": "A weather station reports one of four conditions with probabilities sunny 0.5, cloudy 0.25, rainy 0.125, snowy 0.125. Compute the entropy in bits.",
              "hint": "$H=-\\sum p\\log_2 p$. Note $\\log_2 0.5=-1$, $\\log_2 0.25=-2$, $\\log_2 0.125=-3$.",
              "solution": "$H=-(0.5(-1)+0.25(-2)+0.125(-3)+0.125(-3))=0.5+0.5+0.375+0.375=\\mathbf{1.75}$ bits. (This is below the $\\log_2 4=2$ bits a uniform four-way report would have — the sunny bias makes it more predictable.)"
            },
            {
      ...
      "lessons": [
        {
          ...
          "mcq": [
            ...
            {
              "q": "A BSC with $p=0.3$ (where $H(0.3)\\approx 0.88$) has capacity about:",
              "choices": [
                "$0.88$ bits/use",
                "$0.12$ bits/use",
                "$0.5$ bits/use",
              ...
              "answer": 1,
              "explain": "$C=1-H(0.3)=1-0.88=0.12$ bits per use — heavier noise leaves little reliable rate."
            },
            {
