      ...
      "lessons": [
        {
          ...
          "mcq": [
            ...
            {
              "q": "What does STL offer that classical moving-average decomposition cannot?",
              "choices": [
                "A seasonal component that can evolve over time, plus robustness to outliers via loess weighting",
                "An exact closed-form solution",
                "Removal of the need for a seasonal period",
                "Guaranteed stationary remainders"
              ],
              "answer": 0,
              "explain": "Loess-smoothing each cycle-subseries lets the seasonal shape drift, and the outer robustness loop downweights aberrant points — the two failure modes of the classical method."
            }
          ],
          "flashcards": [
            {
            ...
            {
              "front": "STL decomposition",
              "back": "$y_t=T_t+S_t+R_t$ by iterated <b>loess</b>: seasonal from smoothed cycle-subseries (can evolve), trend from the deseasonalized series, outer loop downweights outliers. Anomalies live in $R_t$."
            },
            {
              "front": "Additive vs multiplicative decomposition",
              "back": "Multiplicative when the seasonal swing grows with the level ($y=T\\cdot S\\cdot R$) — take logs and it becomes additive."
            }
          ],
          "homework": [
            {
