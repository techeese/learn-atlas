...
Currently **133 lessons · 1,596 fact-checked MCQs · 799 flashcards · 397 homework problems · 258 worked
...
- **Spawn a Test (Mastery mode)** — build a custom exam from the 1,596-question bank; scope it to *only what you've completed*, your *weak spots*, a topic, or everything; 5/10/20/40 questions. **Mastery mode (default on)** re-queues every wrong answer until you get it right — no casual remembering.
...
- **Knowledge Constellation** — a radial map of all 133 concepts branching out from a central hub (foundations near the core, advanced toward the rim), cross-topic prerequisites arcing through the middle, nodes colored by mastery; hover to trace dependencies, click to open. Fits-to-width on mobile.
