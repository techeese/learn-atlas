...
Currently **148 lessons · 1,992 fact-checked MCQs · 889 flashcards · 442 homework problems · 298 worked
examples · 36 interactive visualizations**, each lesson with rendered math, step-by-step worked examples, and
...
- **Gamification** — XP (with a floating "+XP" reward burst and an animated level ring), 10 named levels (Novice → Polymath) shown as a ranks ladder, daily streak, **43 achievements** with a collection-progress bar, and a level-up confetti celebration.
