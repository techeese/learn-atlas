...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ Top ps-causation-confounding 8→16 MCQ (gate parity-warns it). Possible follow-on causal lessons if owner wants depth: backdoor/propensity, instrumental variables, causal ML.
