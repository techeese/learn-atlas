...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ MCQ runway (7 of 17 done): remaining at 8 MCQs — ML: all 10 (knn, decision-trees, linear-regression, logistic-regression, regularization, svm, naive-bayes,
   kmeans, ensembles, model-selection). One lesson/iter, hand-verify every answer key, de-skew new 8 to 2/2/2/2.
