...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 620: **batch 13 — ml-svm 8→16**. ✅ iter 621: **batch 14 — ml-naive-bayes 8→16** (posterior 0.77/variants/Laplace; 4/4/4/4; headless 16; SW →v562).
   ⏳ MCQ runway (14 of 17 done): remaining at 8 MCQs — ML: kmeans, ensembles, model-selection (3 left). Then a step-back when the runway completes.
