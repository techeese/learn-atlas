...
- More viz ideas (27 widgets now; CLT iter 74, normal-explorer iter 76, covariance-scatter iter 79, CI-coverage
  iter 84, diffusion noising iter 89, convex-landscape/GD-trap iter 92): MDP policy-iteration, a BPE-merge animation,
  a learning-rate-schedule plot, a p-value/hypothesis-test visual, a VAE latent-space explorer, a GAN training-dynamics demo.
