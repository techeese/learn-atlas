...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ Deep-dive parity remaining: ps-conjugate-priors, ps-bayesian-decisions, ps-computational-bayes each need 3 deep-dives (one lesson/iter). Then Module 6 truly matches site standard on EVERY dimension.
