...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 617: **batch 10 — ml-linear-regression 8→16**. ✅ iter 618: **batch 11 — ml-logistic-regression 8→16** (sigmoid/odds numerics; 4/4/4/4; headless 16; SW →v559).
   ⏳ MCQ runway (11 of 17 done): remaining at 8 MCQs — ML: regularization, svm, naive-bayes, kmeans, ensembles, model-selection (6 left).
