...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 667: **Bayesian lessons connected into the prereq graph** (ps-bayesian-inference & ps-computational-bayes → c-definite-integral-riemann). Module 6 now fully integrated (lessons·16 MCQ·viz·glossary·code·prereqs).
