...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ Top ps-causal-estimation 8→16 MCQ (gate parity-warns). Causal module (3 lessons) is now a solid sub-area; further causal depth optional (causal ML/fairness, sensitivity analysis).
