...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 669: deep-dives ps-conjugate-priors. ✅ iter 670: deep-dives ps-bayesian-decisions (estimator↔loss, HPD vs equal-tailed, value of information).
   ⏳ Deep-dive parity remaining: ps-computational-bayes (last one). Then Module 6 matches site standard on EVERY dimension (lessons·16 MCQ·viz·glossary·code·prereqs·3 deep-dives).
