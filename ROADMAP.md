...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ Top ps-causal-graphs 8→16 MCQ (gate parity-warns). Causal thread further (bounded, owner can redirect): IV/propensity estimation, causal ML / fairness. Consider grouping causal lessons into their own PS module if the thread reaches 3+.
