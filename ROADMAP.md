...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 672: **step-back full sweep (169 lessons, errs=0/bad=none)** + **gate now warns on below-parity lessons** (16 MCQ/6 cards/3 ex/3 hw/3 dd) — auto-catches future content gaps. All lessons currently at standard.
