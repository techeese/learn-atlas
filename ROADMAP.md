...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ Causal thread next (deepen, bounded one-lesson-at-a-time): a "Causal Graphs & the Backdoor Criterion" lesson built around causal-dag; later IV/propensity, causal ML.
