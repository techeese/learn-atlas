...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ⏳ Causal thread further (bounded, owner can redirect): a 3rd lesson "Estimating Causal Effects" (RCT/A-B stats, propensity scores, IV, diff-in-diff) for the new module.
