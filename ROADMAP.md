...
2. **Deepen the existing six** — ✅✅ COMPLETE (iter 99). Every original topic now has a 7th frontier/advanced module,
   ...
   ✅ iter 672: step-back sweep + gate parity warnings. ✅ iter 673: **NEW viz it-differential-entropy-viz** (115th — Gaussian h goes negative; IT 5/7→6/7). gate GREEN, headless h=2.05→−1.27, screenshot, SW →v611.
